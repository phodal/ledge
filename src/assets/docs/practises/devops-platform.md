...
越来越来多的组织开始搞敏捷和 DevOps 转型，打造了很多的 DevOps 基础设施，比如有管理需求的 Jira， 有持续集成的 Jenkis，有容器编排的 K8S 等等。可是这纷繁复杂的 DevOps 工具链，同时也给企业带来新的困扰。
...
![度量-持续改进-组织升级](https://images-cdn.shimo.im/aSJU2okShFmP7U4A.png)
...
![研发活动数据](https://images-cdn.shimo.im/pmBbEKFMrwvej7il.png)
